...
currently there isn't much to say here. This is a simple interface for console
logging. It provides a few functions, C<log_info>, C<log_debug>, C<log_warn>,
...
A message is printed to standard error, prefixed with the filename, line number,
and originating subroutine of the message. I will add more options for
